...
public class NetWriter
{
    ...
    private byte[] GetDataBuffer()
    {
        ...
        Debug.Log("_headBuffer.Length " + _headBuffer.Length);
        Debug.Log("_bodyBuffer.Length " + _bodyBuffer.Length);
        //加头长度,合并body
        byte[] buffer = new byte[_headBuffer.Length + _bodyBuffer.Length];
