...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(UIGridContainer)),
        _GT(typeof(LoopScrollView)),
        _GT(typeof(LoopItemData)),
        _GT(typeof(UILuaTools)),
        ...
        _GT(typeof(DontDestroyManager)),
        _GT(typeof(PomeloGameManager)),
        _GT(typeof(PomeloNetworkManager)),

        _GT(typeof(NetWriter)),
        _GT(typeof(Net)),
