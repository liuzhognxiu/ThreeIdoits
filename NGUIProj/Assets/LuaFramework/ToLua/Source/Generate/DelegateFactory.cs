...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(OnPathDelegate), factory.OnPathDelegate);
		...
		dict.Add(typeof(LoopScrollView.DelegateHandler), factory.LoopScrollView_DelegateHandler);
		dict.Add(typeof(System.Action<NotiData>), factory.System_Action_NotiData);
		dict.Add(typeof(Net.RequestNotifyDelegate), factory.Net_RequestNotifyDelegate);
		dict.Add(typeof(Net.NetError), factory.Net_NetError);
		dict.Add(typeof(Net.CommonDataCallback), factory.Net_CommonDataCallback);
		dict.Add(typeof(System.Action<ActionResult>), factory.System_Action_ActionResult);
		...
		DelegateTraits<OnPathDelegate>.Init(factory.OnPathDelegate);
		...
		DelegateTraits<LoopScrollView.DelegateHandler>.Init(factory.LoopScrollView_DelegateHandler);
		DelegateTraits<System.Action<NotiData>>.Init(factory.System_Action_NotiData);
		DelegateTraits<Net.RequestNotifyDelegate>.Init(factory.Net_RequestNotifyDelegate);
		DelegateTraits<Net.NetError>.Init(factory.Net_NetError);
		DelegateTraits<Net.CommonDataCallback>.Init(factory.Net_CommonDataCallback);
		DelegateTraits<System.Action<ActionResult>>.Init(factory.System_Action_ActionResult);
		...
		TypeTraits<OnPathDelegate>.Init(factory.Check_OnPathDelegate);
		...
		TypeTraits<LoopScrollView.DelegateHandler>.Init(factory.Check_LoopScrollView_DelegateHandler);
		TypeTraits<System.Action<NotiData>>.Init(factory.Check_System_Action_NotiData);
		TypeTraits<Net.RequestNotifyDelegate>.Init(factory.Check_Net_RequestNotifyDelegate);
		TypeTraits<Net.NetError>.Init(factory.Check_Net_NetError);
		TypeTraits<Net.CommonDataCallback>.Init(factory.Check_Net_CommonDataCallback);
		TypeTraits<System.Action<ActionResult>>.Init(factory.Check_System_Action_ActionResult);
		...
		StackTraits<OnPathDelegate>.Push = factory.Push_OnPathDelegate;
		...
		StackTraits<LoopScrollView.DelegateHandler>.Push = factory.Push_LoopScrollView_DelegateHandler;
		StackTraits<System.Action<NotiData>>.Push = factory.Push_System_Action_NotiData;
		StackTraits<Net.RequestNotifyDelegate>.Push = factory.Push_Net_RequestNotifyDelegate;
		StackTraits<Net.NetError>.Push = factory.Push_Net_NetError;
		StackTraits<Net.CommonDataCallback>.Push = factory.Push_Net_CommonDataCallback;
		StackTraits<System.Action<ActionResult>>.Push = factory.Push_System_Action_ActionResult;
	}
	...
	class OnPathDelegate_Event : LuaDelegate
	{
		public OnPathDelegate_Event(LuaFunction func) : base(func) { }
		public OnPathDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public OnPathDelegate OnPathDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			OnPathDelegate fn = delegate(Pathfinding.Path param0) { };
			return fn;
		}

		if(!flag)
		{
			OnPathDelegate_Event target = new OnPathDelegate_Event(func);
			OnPathDelegate d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			OnPathDelegate_Event target = new OnPathDelegate_Event(func, self);
			OnPathDelegate d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_OnPathDelegate(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(OnPathDelegate), L, pos);
	}

	void Push_OnPathDelegate(IntPtr L, OnPathDelegate o)
	{
		ToLua.Push(L, o);
	}
	...
	class UIGridContainer_OnReposition_Event : LuaDelegate
	{
		public UIGridContainer_OnReposition_Event(LuaFunction func) : base(func) { }
		public UIGridContainer_OnReposition_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public UIGridContainer.OnReposition UIGridContainer_OnReposition(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			UIGridContainer.OnReposition fn = delegate() { };
			return fn;
		}

		if(!flag)
		{
			UIGridContainer_OnReposition_Event target = new UIGridContainer_OnReposition_Event(func);
			UIGridContainer.OnReposition d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			UIGridContainer_OnReposition_Event target = new UIGridContainer_OnReposition_Event(func, self);
			UIGridContainer.OnReposition d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_UIGridContainer_OnReposition(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(UIGridContainer.OnReposition), L, pos);
	}

	void Push_UIGridContainer_OnReposition(IntPtr L, UIGridContainer.OnReposition o)
	{
		ToLua.Push(L, o);
	}

	class LoopScrollView_DelegateHandler_Event : LuaDelegate
	{
		public LoopScrollView_DelegateHandler_Event(LuaFunction func) : base(func) { }
		public LoopScrollView_DelegateHandler_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public LoopScrollView.DelegateHandler LoopScrollView_DelegateHandler(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			LoopScrollView.DelegateHandler fn = delegate(LoopItemObject param0, LoopItemData param1) { };
			return fn;
		}

		if(!flag)
		{
			LoopScrollView_DelegateHandler_Event target = new LoopScrollView_DelegateHandler_Event(func);
			LoopScrollView.DelegateHandler d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			LoopScrollView_DelegateHandler_Event target = new LoopScrollView_DelegateHandler_Event(func, self);
			LoopScrollView.DelegateHandler d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_LoopScrollView_DelegateHandler(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(LoopScrollView.DelegateHandler), L, pos);
	}

	void Push_LoopScrollView_DelegateHandler(IntPtr L, LoopScrollView.DelegateHandler o)
	{
		ToLua.Push(L, o);
	}
	...
	class Net_RequestNotifyDelegate_Event : LuaDelegate
	{
		public Net_RequestNotifyDelegate_Event(LuaFunction func) : base(func) { }
		public Net_RequestNotifyDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(Net.Status param0)
		{
			func.BeginPCall();
			func.Push(param0);
			func.PCall();
		...
		public void CallWithSelf(Net.Status param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public Net.RequestNotifyDelegate Net_RequestNotifyDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			Net.RequestNotifyDelegate fn = delegate(Net.Status param0) { };
			return fn;
		}

		if(!flag)
		{
			Net_RequestNotifyDelegate_Event target = new Net_RequestNotifyDelegate_Event(func);
			Net.RequestNotifyDelegate d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			Net_RequestNotifyDelegate_Event target = new Net_RequestNotifyDelegate_Event(func, self);
			Net.RequestNotifyDelegate d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_Net_RequestNotifyDelegate(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(Net.RequestNotifyDelegate), L, pos);
	}

	void Push_Net_RequestNotifyDelegate(IntPtr L, Net.RequestNotifyDelegate o)
	{
		ToLua.Push(L, o);
	}

	class Net_NetError_Event : LuaDelegate
	{
		public Net_NetError_Event(LuaFunction func) : base(func) { }
		public Net_NetError_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(Net.eNetError param0, int param1, string param2)
		{
			func.BeginPCall();
			func.Push(param0);
			func.Push(param1);
		...
		public void CallWithSelf(Net.eNetError param0, int param1, string param2)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public Net.NetError Net_NetError(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			Net.NetError fn = delegate(Net.eNetError param0, int param1, string param2) { };
			return fn;
		}

		if(!flag)
		{
			Net_NetError_Event target = new Net_NetError_Event(func);
			Net.NetError d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			Net_NetError_Event target = new Net_NetError_Event(func, self);
			Net.NetError d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_Net_NetError(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(Net.NetError), L, pos);
	}

	void Push_Net_NetError(IntPtr L, Net.NetError o)
	{
		ToLua.Push(L, o);
	}

	class Net_CommonDataCallback_Event : LuaDelegate
	{
		public Net_CommonDataCallback_Event(LuaFunction func) : base(func) { }
		public Net_CommonDataCallback_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public bool Call(NetReader param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public bool CallWithSelf(NetReader param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public Net.CommonDataCallback Net_CommonDataCallback(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			Net.CommonDataCallback fn = delegate(NetReader param0) { return false; };
			return fn;
		}

		if(!flag)
		{
			Net_CommonDataCallback_Event target = new Net_CommonDataCallback_Event(func);
			Net.CommonDataCallback d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			Net_CommonDataCallback_Event target = new Net_CommonDataCallback_Event(func, self);
			Net.CommonDataCallback d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_Net_CommonDataCallback(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(Net.CommonDataCallback), L, pos);
	}

	void Push_Net_CommonDataCallback(IntPtr L, Net.CommonDataCallback o)
	{
		ToLua.Push(L, o);
	}

	class System_Action_ActionResult_Event : LuaDelegate
	{
		public System_Action_ActionResult_Event(LuaFunction func) : base(func) { }
		public System_Action_ActionResult_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(ActionResult param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(ActionResult param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Action<ActionResult> System_Action_ActionResult(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<ActionResult> fn = delegate(ActionResult param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_ActionResult_Event target = new System_Action_ActionResult_Event(func);
			System.Action<ActionResult> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_ActionResult_Event target = new System_Action_ActionResult_Event(func, self);
			System.Action<ActionResult> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_ActionResult(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<ActionResult>), L, pos);
	}

	void Push_System_Action_ActionResult(IntPtr L, System.Action<ActionResult> o)
	{
		ToLua.Push(L, o);
	}
