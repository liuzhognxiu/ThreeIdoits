...
public class SeekerWrap
{
	...
	{
		L.BeginClass(typeof(Seeker), typeof(UnityEngine.MonoBehaviour));
		...
		L.RegFunction("GetNewPath", GetNewPath);
	...
	static int StartPath(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<Pathfinding.Path, OnPathDelegate>(L, 2))
			{
				Seeker obj = (Seeker)ToLua.CheckObject<Seeker>(L, 1);
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Vector3, UnityEngine.Vector3, OnPathDelegate>(L, 2))
			{
				Seeker obj = (Seeker)ToLua.CheckObject<Seeker>(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 3);
				OnPathDelegate arg2 = (OnPathDelegate)ToLua.ToObject(L, 4);
				Pathfinding.Path o = obj.StartPath(arg0, arg1, arg2);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 4 && TypeChecker.CheckTypes<Pathfinding.Path, OnPathDelegate, int>(L, 2))
			{
				Seeker obj = (Seeker)ToLua.CheckObject<Seeker>(L, 1);
				Pathfinding.Path arg0 = (Pathfinding.Path)ToLua.ToObject(L, 2);
				OnPathDelegate arg1 = (OnPathDelegate)ToLua.ToObject(L, 3);
			...
			else if (count == 5)
			{
				...
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 3);
				OnPathDelegate arg2 = (OnPathDelegate)ToLua.CheckDelegate<OnPathDelegate>(L, 4);
	...
	static int get_pathCallback(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Seeker obj = (Seeker)o;
			OnPathDelegate ret = obj.pathCallback;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_preProcessPath(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Seeker obj = (Seeker)o;
			OnPathDelegate ret = obj.preProcessPath;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_postProcessPath(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Seeker obj = (Seeker)o;
			OnPathDelegate ret = obj.postProcessPath;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
