...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		UIGridContainerWrap.Register(L);
		LoopScrollViewWrap.Register(L);
		LoopItemDataWrap.Register(L);
		UILuaToolsWrap.Register(L);
		UtilityWrap.Register(L);
		DontDestroyManagerWrap.Register(L);
		PomeloGameManagerWrap.Register(L);
		PomeloNetworkManagerWrap.Register(L);
		NetWriterWrap.Register(L);
		NetWrap.Register(L);
		...
		L.RegFunction("OnPathDelegate", OnPathDelegate);
		...
		L.RegFunction("Action_ActionResult", System_Action_ActionResult);
		L.EndModule();
	...
	static int OnPathDelegate(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<OnPathDelegate>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<OnPathDelegate>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_ActionResult(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<ActionResult>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<ActionResult>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
